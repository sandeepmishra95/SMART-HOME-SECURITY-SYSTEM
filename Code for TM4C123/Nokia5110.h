...
#define CONTRAST                0xBB  // Worked for me :)
...
//  ,{0x78, 0x46, 0x41, 0x46, 0x78} // 7f DEL
  ,{0x1f, 0x24, 0x7c, 0x24, 0x1f} // 7f UT sign
	,{0x10, 0x10, 0x7c, 0x38, 0x10} // 80 Arrow sign (->)
};

//enums for easy parameter passing of functions
enum typeOfWrite
{
...
enum typeOfMode
{
	LIGHT, // To print the Text in LIGHT Mode
	DARK	// To print the Text in Dark Mode
};
...
void Nokia5110_OutChar(unsigned char data , enum typeOfMode mode);
...
// outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_OutString(char *ptr , enum typeOfMode mode);
...
// outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_DrawFullImage(const char *ptr, enum typeOfMode type);

void lcdwrite(enum typeOfWrite type, char message); // Writes data or command to the LCD
